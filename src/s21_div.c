...
s21_big_decimal big_division(s21_big_decimal *value_1,
  ...
  while (big_comparison(*value_1, value_2) == VAL1_GREATER_THAN_VAL2) {
    s21_big_decimal del = value_2;
    int i = 0;
    if (big_comparison(del, *value_1) == VAL2_GREATER_THAN_VAL1 ||
        big_comparison(del, *value_1) == VALUES_IS_EQUAL) {
      while (big_comparison(del, *value_1) == VAL2_GREATER_THAN_VAL1 ||
             big_comparison(del, *value_1) == VALUES_IS_EQUAL) {
